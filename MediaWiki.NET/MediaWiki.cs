...
namespace MediaWikiNET
{
    public class MediaWiki
    {
        ...
        /// 
        /// </summary>
        /// <param name="Wiki">URL to the wiki, Example: minecraft.gamepedia.com </param>
        public MediaWiki(string Wiki)
        {
            //Language = language;
            this.Wiki = Wiki;
            Format = Format.XML;
        ...
        /// <summary>
        /// Wiki URL to search some entries.
        /// </summary>
        ...
        public QueryResult Search(string query)
        {
            ...
            _client.BaseUrl = string.Format(UseTLS ? "https://{0}/" : "http://{0}/", Wiki);
            ...
            if (results.Search != null)
            {
                ...
                {
                    search.Url = UseTLS ? new Uri("https://" + Wiki + "/" + search.Title) : new Uri("http://" + Wiki + "/" + search.Title);
                }
            }
